...
If a starter template was selected, initialize the project using the documented starter command; otherwise, begin with the highest-priority foundational component identified in the project structure.
```
