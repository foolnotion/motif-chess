...
[If a project context file exists, summarize the extracted technical preferences, including languages/frameworks, tools/libraries, development patterns, and platform preferences. Otherwise, state that no existing technical preferences were found and that they will be established now.]"
